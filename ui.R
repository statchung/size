      ...
      tabPanel("Fractional FD", 
               sidebarPanel(
                 ...
                 conditionalPanel("input.delta_type2==1",
                                  ...
                                  numericInput('de2_2','SD(Interaction)',1,min=0,max=10),
                 ...
                 conditionalPanel("input.delta_type2==2", 
                                  ...
                                  numericInput('de12_2','Range of effect(Interaction)',1,min=0,max=10),
      ...
      mainPanel(
        tabsetPanel(
          ...
          tabPanel("Delta vs Power Plot", 
                   sidebarLayout(
                     sidebarPanel(
                       selectInput("plot_order2", "List of factors:",
                                   choices=c(toupper(letters)[1:2],"ALL"))
                       ),
                     mainPanel(plotOutput("Delta_graph2"),
                               tableOutput("values2")
                               )
                     )
                   ),
